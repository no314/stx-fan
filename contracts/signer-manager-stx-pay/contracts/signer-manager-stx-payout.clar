...
(define-public (jing-reconcile)
  (let (
    ...
    (try! (authorize-converter))
    (match (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
        get-settlement cycle
      )
      settlement (let (
          (totals (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
...
(define-private (jing-call-deposit
  ...
  (match (as-contract?
      ...
      (try! (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
...
(define-read-only (jing-current-cycle)
  (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
    get-current-cycle
  )
)
...
(define-private (jing-walk-step
  ...
  (if (and
      ...
      (is-none (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
  ...
  (let ((cycle (jing-current-cycle)))
    {
      ...
      market: 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2,
      phase: (jing-phase),
      jing-cycle: cycle,
      totals: (contract-call? 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.sbtc-stx-0-jing-v2
        get-cycle-totals cycle
