;; Zero to Claiming batch reader, revision 3 (mainnet). Revision 2 with one
...
(define-private (unclaimed-one (e {signer: principal, staker: principal, cycle: uint}))
  {staker: (get staker e), cycle: (get cycle e),
   unclaimed: (contract-call? 'SP000000000000000000002Q6VF78.pox-5 get-earned-staker-rewards
